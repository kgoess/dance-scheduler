...
get '/' => requires_login sub {
    ...
    my $series_columns = [
        ...
        },
        {
            ...
            type  => "text",
            required => 1,
            # "help" is unused, but we should add it
            help => "This is a short, permanent ID for the series, general enough to survive name changes, used for example in links in HTML files on the filesystem.",
        },
        {
            name => "frequency",
            label => "Frequency",
